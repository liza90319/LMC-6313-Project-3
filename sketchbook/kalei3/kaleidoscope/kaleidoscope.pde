...
String []files = {"spider.jpg", "bike.jpg", "godzilla.jpg", "sm_mm0.jpg",
    "stained_glass.jpg", "marbles.jpg", "star.jpg"};
...
void setup(){
    ...
    b1  = loadImage("sm_left_button.png");
    b2  = loadImage("sm_right_button.png");  
}
